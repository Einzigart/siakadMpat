...
<body>
    ...
    <main>
        ...
        @if (session('role_id') == 1)
            ...
            <form class="form-admin hidden " id="form-tambah-dosen" action="" method="POST">
        ...
        <table>
            ...
            @foreach ($dosen as $d)
                <tr>
                    ...
                    @if(session("role_id")==1)
                    <td>
                        <a class="edit" href="./admin-dosen-edit.php?nip=">Edit</a> |
                        <a class="delete" href="../function/admin/admin-dosen-del.php?nip="
